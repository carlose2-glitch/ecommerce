...
const evaluateIfTrue = async (d) => {
  ...
  const data = {
    ...
    brand: brand.value,
    price: price.value,
    mm38: mm38.children[1].textContent,
    mm39: mm39.children[1].textContent,
    mm40: mm40.children[1].textContent,
    mm41: mm41.children[1].textContent,
    t: total.value,
  };
  ...
  if(brand.value.trim() !== '' && description.value.trim() !== '' && price.value.trim() !== '' && mm38.children[1].textContent.trim() !== '' && mm39.children[1].textContent.trim() !== '' && mm40.children[1].textContent.trim() !== '' && mm41.children[1].textContent.trim() !== ''){
